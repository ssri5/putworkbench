...
* (Current) Version: 1.6 (Build Date: 17-May-2018)

### How do I get set up? ###

#### I want to try the tool ####
* Download the tool for Windows (putwb-1.6-windows.zip) or Linux (putwb-1.6-linux.zip) from the Downloads section of the repository.  
...
* The build will produce a jar file called __putwb-1.6-complete.jar__ (as well as some other files for platform dependent installations).
