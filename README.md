...
* (Current) Version: 1.51 (Build Date: 18-Apr-2018)

### How do I get set up? ###

#### I want to try the tool ####
* Download the tool for Windows (putwb-1.51-windows.zip) or Linux (putwb-1.51-linux.zip) from the Downloads section of the repository.  
...
* The build will produce a jar file called __putwb-1.51-complete.jar__ (as well as some other files for platform dependent installations).
